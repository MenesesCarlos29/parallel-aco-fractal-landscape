...
int main(int argc, char* argv[]) {
    try {
        ...
        std::cout << "--- Q3 OpenMP memoire partagee (timings par etape, SoA) ---\n";
        ...
        std::ofstream csv_file("results/Q3_timings_breakdown.csv");
        if (!csv_file.is_open()) {
            std::cerr << "Erreur: impossible d'ecrire results/Q3_timings_breakdown.csv\n";
            return 1;
        }
        ...
        std::cout << "\n=== Resultats Q3 (timings par etape) ===\n";
        std::cout << "Moyennes (ms):"
                  ...
                  << " | render=" << mean_render
                  << " | total=" << mean_total << "\n";
        std::cout << "CSV local genere: results/Q3_timings_breakdown.csv\n";
